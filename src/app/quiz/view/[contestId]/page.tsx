...
const FormLayout = (context: {
  ...
  const handleGetQuizResult = () => {
    ...
    fetch(`${process.env.API_BASE_URL}/admin/user-result`, requestOptions)
      .then((response: Response) => response.json())
      .then((result) => {
        if (result.status === 200 && result.statusText === "OK") {
          setQuizResult(result.data.data.Questions);
        }
      })
      .catch((error: Error) => console.error(error))
      .finally(() => setLoading(false));
            ...
            <div className="overflow-hidden rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
              <div className="bg-white">
                <div className="mx-auto max-w-7xl px-6 py-16 lg:px-8">
                  <div className="divide-gray-900/10 mx-auto max-w-4xl divide-y">
                    <h2 className="text-gray-900 text-2xl font-bold leading-10 tracking-tight">
                      Quiz Result
                    </h2>
