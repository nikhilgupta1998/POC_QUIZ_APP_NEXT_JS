...
const SignIn: React.FC = () => {
  ...
  const handleUserLogin = (event: React.FormEvent<HTMLFormElement>) => {
    ...
    fetch(`${process.env.API_BASE_URL}/auth/login`, requestOptions)
      ...
      .then((result) => {
        ...
        if (result.status === 200 && result.statusText === "OK") {
          signin({
            ...
            name: result.data.data.user.username,
  ...
  const handleUserSignUp = (event: React.FormEvent<HTMLFormElement>) => {
    setLoading(true);
    event.preventDefault();
    const myHeaders = new Headers();
    myHeaders.append("Content-Type", "application/json");
    ...
    const raw = JSON.stringify({
      username: "Nikhil Gupta8",
      email: "nikhilgupta8@gmail.com",
      password: "test",
      isAdmin: false,
    });
    ...
    fetch(`${process.env.API_BASE_URL}/auth/Signup`, requestOptions)
      .then((response) => response.json())
      .then((result) => {
        if (result.status === 200 && result.statusText === "OK") {
          signin({
  ...
  return (
    <div className="relative">
      ...
      <DefaultLayout>
        <Breadcrumb pageName={formType === "SignIn" ? "Sign In" : "Sign Up"} />
              ...
              <div className="px-26 py-17.5 text-center">
                <Link className="mb-5.5 inline-block" href="/">
                  <Image
                    ...
                    src={"https://pollpe.in/assets/img/logo.svg"}
                    alt="Logo"
                    width={176}
                    height={32}
                  />
                  <Image
                    ...
                    src={"https://pollpe.in/assets/img/footer-logo.svg"}
                    alt="Logo"
                    width={176}
                    height={32}
                  />
